...
def main():
    ...
    ap.add_argument("--steps", type=int, default=20000, help="Eğitim adım sayısı (toplam)")
    ap.add_argument("--episodes", type=int, default=8, help="Benchmark bölüm sayısı")
    ap.add_argument("--eval_episodes", type=int, default=5, help="Değerlendirme bölüm sayısı")
    ap.add_argument(
        "--skip-train", action="store_true", help="Eğitimi atla; mevcut politikayı kullan"
    )
    args = ap.parse_args()
